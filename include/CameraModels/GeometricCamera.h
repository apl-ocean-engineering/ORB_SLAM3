...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        virtual bool epipolarConstrain(const std::shared_ptr<GeometricCamera> &otherCamera, const cv::KeyPoint& kp1, const cv::KeyPoint& kp2, const Eigen::Matrix3f& R12, const Eigen::Vector3f& t12, const float sigmaLevel, const float unc) = 0;
        ...
        virtual bool matchAndtriangulate(const cv::KeyPoint& kp1, const cv::KeyPoint& kp2, const std::shared_ptr<GeometricCamera> &pOther,
